...
const pathname = usePathname()
  ...
  return (
    <aside className="h-screen w-[280px] border-r border-border bg-background overflow-hidden">
  ...
  <div className="flex items-center gap-3">
    ...
    <div className="min-w-0">
      ...
      <span className="text-xs font-semibold uppercase text-red-500">
        ...
        {/* Navigation */}
        <nav className="flex-1 overflow-y-auto space-y-2 px-3 py-5">
      ...
      className={`
        ...
        ${
          isActive
            ...
            : 'text-muted-foreground hover:bg-blue-300 hover:text-white'
        }
      `}
    >
      <span
